var sceneMenu = new Phaser.Class({
    ...
    create: function () {
        ...
        X_POSITION = {
            'LEFT': 0, // Mengasumsikan game.canvas.width akan menjadi 720
            'CENTER': 540 / 2, // 270
            'RIGHT': 540,
        };

        Y_POSITION = {
            'TOP': 0, // Mengasumsikan game.canvas.height akan menjadi 1280
            'CENTER': 960 / 2, // 480
            'BOTTOM': 960,
        };
        ...
        var titleGame = this.add.image(X_POSITION.CENTER, Y_POSITION.CENTER - 200, 'Title'); // Y disesuaikan untuk potret

        // menambahkan tombol play
        var buttonPlay = this.add.image(X_POSITION.CENTER, Y_POSITION.CENTER + 150, 'ButtonPlay'); // Y disesuaikan untuk potret
        ...
        this.input.on('gameobjectup', function (pointer, gameObject) {
            if (gameObject === buttonPlay) {
                ...
                //tombol play yang di-klik, dilepas kliknya (menggunakan this.btnSound)
    ...
    update: function () {
        // Tidak perlu logika update ini jika btnSound sudah diinisialisasi di create.
        // Variabel global snd_touch bermasalah.
        // Lebih baik menggunakan this.btnSound yang diinisialisasi sekali di create.
    }
});